...
mod tests {
    ...
    fn test_args_target_language() {
        let args = Args::try_parse_from(&["deepwiki-rs", "--target-language", "zh"]).unwrap();
    ...
    fn test_into_config_basic() {
        let args =
            Args::try_parse_from(&["deepwiki-rs", "-p", "/test/project", "-o", "/test/output"])
                .unwrap();
    ...
    fn test_into_config_no_cache() {
        let args = Args::try_parse_from(&["deepwiki-rs", "--no-cache"]).unwrap();
    ...
    fn test_into_config_disable_preset_tools() {
        let args = Args::try_parse_from(&["deepwiki-rs", "--disable-preset-tools"]).unwrap();
